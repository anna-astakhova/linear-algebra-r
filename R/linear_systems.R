...
#' below it that has the largest absolute value in the pivot column.
...
#'
#' Solves Ux = b' from the bottom row up.
#' Each variable is solved by substituting previously found values
#' into the equation and dividing by the diagonal pivot.
#'
...
#'
#' Combines row_reduce() and back_substitute() into a single solver.
#' This is the main interface — pass A and b separately.
#'
